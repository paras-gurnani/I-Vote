...
<div class='col-md-12 container'>
    <form method='put' enctype="multipart/form-data" action="{{route('candidates.update',$candidate->id)}}">
        @csrf
        <div class='row'>
            ...
            <div class='col form-group' style='display:inline-block;'>
                ...
                <select class="field-select" name="field" id="fields" disabled>
                ...
                <textarea class="form-control" id="description" rows="4" name='desc' disabled>{{$candidate->desc}}</textarea>
